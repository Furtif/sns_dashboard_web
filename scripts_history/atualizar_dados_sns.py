...
DATASETS = {
    'atendimentos': {
        ...
        'nome_original': '../public/data/atendimentos_urgencia_triagem_manchester.csv',
    ...
    'trabalhadores': {
        ...
        'nome_original': '../public/data/trabalhadores_grupo_profissional.csv',
    ...
    'monitorizacao': {
        ...
        'nome_original': '../public/data/monitorizacao_sazonal_csh.csv',
