...
try:
    ...
    atendimentos = pd.read_csv('../public/data/atendimentos_urgencia_triagem_manchester.csv', 
                               sep=';', encoding='utf-8-sig')
    
    trabalhadores = pd.read_csv('../public/data/trabalhadores_grupo_profissional.csv', 
                                sep=';', encoding='utf-8-sig')
    ...
    # Salvar
    fact_final.to_csv('../public/data/fact_atendimentos_urgencia_mensal.csv', sep=';', index=False, encoding='utf-8-sig')
...
try:
    # Carregar dados fonte
    monitorizacao = pd.read_csv('../public/data/monitorizacao_sazonal_csh.csv', 
                                sep=';', encoding='utf-8-sig')
    ...
    # Salvar
    fact_monit.to_csv('../public/data/fact_monitorizacao_sazonal.csv', sep=';', index=False, encoding='utf-8-sig')
